...
This procedure needs a data structure where tuples of particles are
stored in lists. In contrast to simple Molecular Dynamics, which is
based only on pairs of particles, we here need to allow tuples
of arbitrary size. The present module provides this more general
