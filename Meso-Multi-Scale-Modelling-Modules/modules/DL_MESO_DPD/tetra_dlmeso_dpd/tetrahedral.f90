...
! TEST: 
! identify the global labels of the 4 nearest neighbours
  nnlab = (/2,3,4,5/)

  dimx = 10._dp; dimy = 10._dp; dimz = 10._dp
  !-----------------------------------------------------------------------------------------
  !assign  coordinates
  ! central atom
  rt1= (/0._dp, 0._dp, 0._dp/)
  !regular tetrahedron
  rt2 = (/ 1._dp, 0._dp, -1/sqrt(2._dp)/)
  rt3 = (/ -1._dp, 0._dp, -1/sqrt(2._dp)/)  
  rt4 = (/ 0._dp, 1._dp, 1/sqrt(2._dp)/)    
  rt5 = (/ 0._dp, -1._dp, 1/sqrt(2._dp)/)       

  print*,"TEST: one regular tetrahedron"
  call compute_tetra (rt1, rt2, rt3, rt4, rt5, qtetra, stetra)
  print*,"q=",qtetra
  print*,"s=",stetra  
  !-----------------------------------------------------------------------------------------
...
98 FORMAT(1p,9(e13.6,3x))
 ...
 !-----------------------------------------------------------------------------------------
  CONTAINS 
    ...
    SUBROUTINE compute_tetra (r1, r2, r3, r4, r5, qtetra, stetra)
!*************************************************************************************
! subroutine to compute q and sk for a set of five particles using their coordinates
!
! authors: s. chiacchiera, january 2018
!************************************************************************************* 
      
  IMPLICIT none
  ! NB: I am using r1 -> xxx etc. It may be better to input the particle
  ! labels instead? For the moment, I keep it.
  ! IMP: xxx,yyy,zzz are private variables, not the same as in the main
  ! NB: I should finally recover the use of subroutine "images"
  REAL(KIND=dp), DIMENSION(3), INTENT(IN):: r1, r2, r3, r4, r5  
  ...
  !-----------------------------------------------------------------------------------------
  xxx (1) = r1 (1); yyy (1) = r1 (2); zzz (1) = r1 (3)
  xxx (2) = r2 (1); yyy (2) = r2 (2); zzz (2) = r2 (3)
  xxx (3) = r3 (1); yyy (3) = r3 (2); zzz (3) = r3 (3)
  xxx (4) = r4 (1); yyy (4) = r4 (2); zzz (4) = r4 (3)
  xxx (5) = r5 (1); yyy (5) = r5 (2); zzz (5) = r5 (3)
  !-----------------------------------------------------------------------------------------
  qtetra = 0._dp
  angle_ave = 0._dp 
  cangle_ave = 0._dp 
