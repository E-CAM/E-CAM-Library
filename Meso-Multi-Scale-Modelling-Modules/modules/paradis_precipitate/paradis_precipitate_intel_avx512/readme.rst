...
..  sidebar:: Software Technical Information
  ...
  Name
    ParaDiS_Precipitate_INTEL_AVX512
...
an extension of the ParaDIS DDD code (LLNL, http://paradis.stanford.edu/) where dislocation/precipitate interactions are included. The extension is for an HPC environment, in which the original code has been optimized for the new Puhti computer at CSC in Finland.  
