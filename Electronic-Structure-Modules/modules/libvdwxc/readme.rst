...
library consists of 400 different local and semi-local functionals, and it is
linked by 20 different codes. In other words, when using this library,
scientists have thousands different functional and code combinations to choose
...
where ``x.y.z`` is the version of libvdwxc you want to install,
