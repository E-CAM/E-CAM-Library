...
I provide simple modifications to the SRP fix files in the LAMMPS source code.
...
You can find the modifications for the SRP fix on the `minDist2segments_KKT GitLab repository <https://gitlab.com/pcarrivain/mindist2segments_kkt/for_SRP>`_.
