...
The module software has been entirely refactored in modern C++ (version 2014 or later) so as to: (a) run with high efficiency on massively parallel platforms 
